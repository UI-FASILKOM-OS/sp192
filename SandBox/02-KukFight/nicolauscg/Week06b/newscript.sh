...
input="test-file.txt"
eval "rm -rf $TESTDIR1; mkdir $TESTDIR1; cd $TESTDIR1; touch file1.txt file2.txt file.awk program2.c;"
eval "echo 'this is file1' > file1.txt; echo 'this is file2' > file2.txt; cd .."
